...
pub fn grass(noise: &Noise, map: &mut AreaMap, width: i32, height: i32, offset: [i32; 2], noise_scale: f32) {
  let short_fg = Color{r:112, g:141, b:64};
  let tall_fg = Color{r:118, g:121, b:72};
  for x in 0..width {
    for y in 0..height {
